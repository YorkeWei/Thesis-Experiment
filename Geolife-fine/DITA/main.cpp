...
int main() {
    ...
    for (int path_i = 0; path_i < 4; path_i++)
    {
        ...
        node* root_node = create_index(index_point_list, initial_trac_id, trajectory_list,  trac_mbr, trac_cell, 0.005);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.02, trac_mbr, trac_cell, 0.005, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.04, trac_mbr, trac_cell, 0.005, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.06, trac_mbr, trac_cell, 0.005, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.08, trac_mbr, trac_cell, 0.005, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.1, trac_mbr, trac_cell, 0.005, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
