...
int main() {
    ...
    for (int path_i = 0; path_i < 4; path_i++)
    {
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.15, trac_mbr, trac_cell, 10, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.2, trac_mbr, trac_cell, 10, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.25, trac_mbr, trac_cell, 10, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.3, trac_mbr, trac_cell, 10, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], root_node, 0.35, trac_mbr, trac_cell, 10, avg_can_gen, avg_can_verify, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
