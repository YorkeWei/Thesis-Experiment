...
int main() {
	...
	for (int path_i = 0; path_i < 4; path_i++)
	{
		...
		{
			startTime = clock();
			search(trajectory_list, query_list[i], 0.15, avg_res);
			endTime = clock();
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], 0.2, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], 0.25, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], 0.3, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
        ...
        {
            startTime = clock();
            search(trajectory_list, query_list[i], 0.35, avg_res);
            endTime = clock();
            avg_query_time += (double)(endTime - startTime) / CLOCKS_PER_SEC;
        }
        avg_query_time /= ((double)query_len);
